...
namespace Battlesnake.PostGen.CodeGenerator {
	...
	public static class Function {
		...
		private static readonly Template function_open = new Template("CREATE FUNCTION %I(%s)");
		private static readonly Template function_returns = new Template("RETURNS %s");
		private static readonly Template function_language = new Template("LANGUAGE %s");
		private static readonly Template function_strict = new Template("STRICT");
		private static readonly Template function_volatile = new Template("%s");
		private static readonly Template function_parallel = new Template("PARALLEL %s");
		private static readonly Template function_security = new Template("SECURITY %s");
		private static readonly Template function_config = new Template("SET %s = %s");
		...
		public static class Argument {
			...
			private static readonly Template function_argument = new Template("%s %s %s");
